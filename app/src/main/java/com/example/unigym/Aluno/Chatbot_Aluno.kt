...
class Chatbot_Aluno : AppCompatActivity() { // Renomeie se necessário
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_chatbot_aluno) // Certifique-se que o nome do layout está correto
    ...
    private fun sendMessageToGemini(prompt: String) {
        ...
        val fullPrompt = "Você é um chatbot de academia amigável. Responda à seguinte pergunta sobre exercícios e responda tudo em 150 caracteres, academia ou dicas de alimentação: \n\n$prompt"
